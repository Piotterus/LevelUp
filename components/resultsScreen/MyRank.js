...
export default class MyRank extends React.Component {
            ...
            <View style={[styles.nextInfoView, styles.shadow, {paddingBottom: 10}]}>
                ...
                <View style={[styles.timeView]}>
                    ...
                    <View style={{flex: 1,flexDirection: 'row', justifyContent: 'flex-end', paddingRight: 20}}>
                        ...
                        <View style={[styles.lineView, {marginLeft: 15, marginRight: 15}]}/>
                        <View style={styles.timeTextView}>
                            <Text style={styles.timeTopText}>
                                {this.props.points}
                            </Text>
                ...
                {/*<View style={styles.knowledgeView}>
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Ranking')} style={[styles.buttonBase, styles.shadow, {backgroundColor: '#2592E6', width: 186}]}>
                                <Text style={{color: '#FFFFFF', fontSize: 13, fontWeight: 'bold'}}>SPRAWDŹ SZCZEGÓŁY</Text>
                            </TouchableOpacity>
                        </View>*/}
            </View>
        )
